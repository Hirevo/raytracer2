...
** Last update Tue Apr  4 22:42:04 2017 Nicolas Polomack
*/
...
void	init_room(t_params *params)
{
  ...
  params->objs[8].reflect = 0;
  params->objs[8].col = get_sfcolor(255, 255, 255, 255);
